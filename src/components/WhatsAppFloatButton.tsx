...
/** Persistent WhatsApp action, fixed bottom-right on every page. */
export function WhatsAppFloatButton() {
  return (
    <a
      ...
      className="fixed right-4 bottom-24 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-whatsapp text-whatsapp-foreground shadow-lift transition-transform duration-200 ease-out hover:scale-105 active:scale-95 md:bottom-6"
    >
